...
import kollections.removeLastOrNull
import kollections.retainAll
import kollections.subList
...
internal class LinearlyTraversableStackImpl<E> : AbstractCollection<E>(), LinearlyTraversableStack<E> {
    ...
    override fun containsAll(elements: Collection<E>): Boolean = list.toKList().containsAll(elements)
