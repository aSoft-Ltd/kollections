...
plugins {
    ...
    alias(kotlinx.plugins.atomicfu) apply false
...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/kollections")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/kollections/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/kollections/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/kollections.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/kollections.git")
            }
        }
    }
}
